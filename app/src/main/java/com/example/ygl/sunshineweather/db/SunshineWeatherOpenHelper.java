...
public class SunshineWeatherOpenHelper extends SQLiteOpenHelper {
    /**
     * Province表建表语句
     */
    ...
    public SunshineWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version){
